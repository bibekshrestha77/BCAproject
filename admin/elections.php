...
if(isset($_POST['create_election'])) {
    ...
    if(strtotime($end_date) <= strtotime($start_date)) {
        ...
        $query = "INSERT INTO elections (title, description, start_date, end_date, status, created_by) 
                  VALUES ('$title', '$description', '$start_date', '$end_date', 'upcoming', {$_SESSION['user_id']})";
...
// Get all elections
$elections = mysqli_query($conn, "SELECT * FROM elections ORDER BY created_at DESC");
                ...
                <?php while($row = mysqli_fetch_assoc($elections)): ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="elections.php?delete=<?php echo $row['id']; ?>" 
                               class="btn-delete" 
