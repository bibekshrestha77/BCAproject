...
if (isset($_POST['create_user'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $query = "INSERT INTO users (username, email, password, role, course_id) 
          VALUES ('$username', '$email', '$password', '$role', $course_id)";
...
$users = mysqli_query(
    $conn,
    "SELECT users.*, courses.course AS course_name 
     FROM users 
...
<div class="users-container">
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($users)): ?>
                    <tr class="<?php echo ($row['id'] == $_SESSION['user_id']) ? 'current-user' : ''; ?>">
                        ...
                        <td><?php echo htmlspecialchars($row['course_name'] ?? 'No Course'); ?></td>
                        <td>
                        ...
                        <td><?php echo $row['last_login'] ? date('M d, Y H:i', strtotime($row['last_login'])) : 'Never'; ?>
                        </td>
                        <td class="actions">
    ...
    <i class="fas fa-edit"></i>
                            ...
                            <?php if ($row['id'] != $_SESSION['admin_id']): ?>
                                <a href="delete_user.php?id=<?php echo $row['id']; ?>" class="btn-delete"
        ...
        <form action="" method="POST" class="admin-form">
            ...
            <div class="form-group">
                ...
                <select name="course_id">
                    ...
                    <?php
                    $courses = mysqli_query($conn, "SELECT * FROM courses ORDER BY course ASC");
